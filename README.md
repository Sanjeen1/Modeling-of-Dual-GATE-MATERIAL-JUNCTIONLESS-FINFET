...
This repository contains the Synopsys Sentaurus TCAD project files, scripts, and simulation setup for modeling a Dual Material Gate Junctionless FinFET (DMG-JLFET) with gate length of 10nm. The work includes structure creation in Sentaurus Structure Editor, implementation of suitable physical models in the device simulation (sdevice) script, and automation of performance metric extraction (Threshold Voltage, Leakage Current, DIBL, Subthreshold Slope) using svisual scripting.
